...
<div class="row" style="margin-top: 200px">
    ...
    <br>
         <input class="btn btn-default btn-primary btn-block" style=" background-image: linear-gradient(to left, #141f72 , #2cb9f9); Width:150px;"; type="submit"  value="Submit"name="Submit" onclick="return confirm('Are you sure you want to delete this item?');" ><br> 
    </div>
</div> 
</form>
</div>
